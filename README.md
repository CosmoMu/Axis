...
- Short-Term TP1–TP41 / Expiry-only Tracking / ER + LOTTO: CODE COMPLETE / LIVE E2E PENDING
...
- SPXW 0DTE Desk: TEST / MOOMOO CAPABILITY GATE BLOCKED / MEMBER SCHEDULER DISABLED
...
Manager 入群审核、自动 3 U.S. Trading Day Trial、风险扫描和 reconciliation 已实现并部署，
